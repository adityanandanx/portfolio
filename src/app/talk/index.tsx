...
const Talk: FC<TalkProps> = ({}) => {
    return (
        <section className="w-full h-[80vh] p-0">
            <div className="w-full p-16 md:p-24 bg-stone-200 dark:bg-stone-700 rounded-xl h-full flex flex-col items-start justify-between">
                <div>
                    <h2 className="text-2xl">Have a project for Me?</h2>
                    <h1
                        style={{ ...syne.style }}
                        className="text-5xl sm:text-6xl md:text-9xl"
                    >
                        Let&rsquo;s Talk
                    </h1>
                    <Button className="text-base leading-none py-4">
                        Get in touch
